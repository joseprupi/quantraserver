#ifndef QUANTRA_FIXED_RATE_BOND_EVALUATOR_H
#define QUANTRA_FIXED_RATE_BOND_EVALUATOR_H

/**
 * FixedRateBondEvaluator — pure QuantLib pricing core for fixed-rate bonds.
 *
 ...
 * mapper. The evaluator pre-computes everything that depends on the discount
...
#endif // QUANTRA_FIXED_RATE_BOND_EVALUATOR_H
