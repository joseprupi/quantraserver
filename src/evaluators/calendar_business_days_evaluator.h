#ifndef QUANTRA_CALENDAR_BUSINESS_DAYS_EVALUATOR_H
#define QUANTRA_CALENDAR_BUSINESS_DAYS_EVALUATOR_H

/**
 * CalendarBusinessDaysEvaluator — pure QuantLib core for the
 ...
 * calendar_business_days_mapper.{h,cpp}. The evaluator touches no market data;
...
#endif // QUANTRA_CALENDAR_BUSINESS_DAYS_EVALUATOR_H
