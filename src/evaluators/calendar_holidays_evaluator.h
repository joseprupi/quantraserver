#ifndef QUANTRA_CALENDAR_HOLIDAYS_EVALUATOR_H
#define QUANTRA_CALENDAR_HOLIDAYS_EVALUATOR_H

/**
 * CalendarHolidaysEvaluator — pure QuantLib core for the
 ...
 * calendar_holidays_mapper.{h,cpp}. The evaluator touches no market data; the
...
#endif // QUANTRA_CALENDAR_HOLIDAYS_EVALUATOR_H
