#ifndef QUANTRA_FLOATING_RATE_BOND_EVALUATOR_H
#define QUANTRA_FLOATING_RATE_BOND_EVALUATOR_H

/**
 * FloatingRateBondEvaluator — pure QuantLib pricing core for floating-rate bonds.
 *
 ...
 * floating_rate_bond_mapper.{h,cpp}. The evaluator reads market data exclusively
 ...
 * table into these QL-typed fields; the evaluator builds the QL FloatingRateBond
...
#endif // QUANTRA_FLOATING_RATE_BOND_EVALUATOR_H
