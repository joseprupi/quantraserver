    ...
    std::shared_ptr<flatbuffers::grpc::MessageBuilder> builder)
{
    ...
    // =========================================================================
    // Create Volatility (20% flat Black vol) - now in Pricing.volatilities
    // =========================================================================
    ...
    cap_floor_builder.add_cap_floor_type(quantra::enums::CapFloorType_Cap);
    ...
    // =========================================================================
    // Create PriceCapFloor - volatility is now a string reference
    // =========================================================================
    auto disc_curve_ref = builder->CreateString("eur_curve");
    auto fwd_curve_ref = builder->CreateString("eur_curve");
    auto vol_ref = builder->CreateString("flat_vol");  // Reference by ID
    ...
    price_cap_floor_builder.add_volatility(vol_ref);  // String reference
