    ...
    std::shared_ptr<flatbuffers::grpc::MessageBuilder> builder)
{
    ...
    // =========================================================================
    // Create Volatility (20% Black vol) - now in Pricing.volatilities
    // =========================================================================
    ...
    vol_builder.add_volatility_type(quantra::enums::VolatilityType_ShiftedLognormal);
    vol_builder.add_constant_vol(0.20);
    auto volatility = vol_builder.Finish();

    // =========================================================================
    // Create Pricing (with curves AND volatilities)
    // =========================================================================
    ...
    std::vector<flatbuffers::Offset<quantra::VolatilityTermStructure>> vols_vector;
    vols_vector.push_back(volatility);
    auto volatilities = builder->CreateVector(vols_vector);
    ...
    pricing_builder.add_volatilities(volatilities);  // NEW: volatilities in Pricing
    ...
    swap_builder.add_swap_type(quantra::enums::SwapType_Payer);
    ...
    swaption_builder.add_exercise_type(quantra::enums::ExerciseType_European);
    swaption_builder.add_settlement_type(quantra::enums::SettlementType_Physical);
    ...
    // =========================================================================
    // Create PriceSwaption - volatility is now a string reference
    // =========================================================================
    auto disc_curve_ref = builder->CreateString("eur_curve");
    auto fwd_curve_ref = builder->CreateString("eur_curve");
    auto vol_ref = builder->CreateString("swaption_vol");  // Reference by ID
    ...
    price_swaption_builder.add_volatility(vol_ref);  // String reference
