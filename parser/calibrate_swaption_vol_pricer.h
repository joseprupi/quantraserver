#ifndef QUANTRA_CALIBRATE_SWAPTION_VOL_PRICER_H
#define QUANTRA_CALIBRATE_SWAPTION_VOL_PRICER_H

/**
 * CalibrateSwaptionVolPricer — pure QuantLib core for the SABR swaption
 ...
 * content-keyed cube cache. This pricer resolves the referenced surface and
 ...
 * calibrate_swaption_vol_mapper.{h,cpp}. The pricer reads market data only
 * through the plain registry fields reg.rates.curves and
 * reg.volatility.swaptionVols; it never touches reg.volatility.models.
 */
...
class CalibrateSwaptionVolPricer {
public:
    CalibrateSwaptionVolResult price(const CalibrateSwaptionVolInputs& inputs,
...
#endif // QUANTRA_CALIBRATE_SWAPTION_VOL_PRICER_H
