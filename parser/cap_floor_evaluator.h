#ifndef QUANTRA_CAP_FLOOR_EVALUATOR_H
#define QUANTRA_CAP_FLOOR_EVALUATOR_H

/**
 * CapFloorEvaluator — pure QuantLib pricing core for caps, floors, and
 ...
 * cap_floor_mapper.{h,cpp}. The evaluator reads market data exclusively from the
...
/// has already converted enums to QL types and parsed the schedule; the evaluator
...
#endif // QUANTRA_CAP_FLOOR_EVALUATOR_H
