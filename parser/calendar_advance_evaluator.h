#ifndef QUANTRA_CALENDAR_ADVANCE_EVALUATOR_H
#define QUANTRA_CALENDAR_ADVANCE_EVALUATOR_H

/**
 * CalendarAdvanceEvaluator — pure QuantLib core for the
 ...
 * calendar_advance_mapper.{h,cpp}. The evaluator touches no market data; the
...
#endif // QUANTRA_CALENDAR_ADVANCE_EVALUATOR_H
