#ifndef QUANTRA_ZERO_COUPON_INFLATION_SWAP_PRICER_H
#define QUANTRA_ZERO_COUPON_INFLATION_SWAP_PRICER_H

/**
 * ZeroCouponInflationSwapPricer — pure QuantLib pricing core for ZCIIS trades.
 *
...
/// already converted enums to QL types; the pricer never touches FlatBuffers.
...
class ZeroCouponInflationSwapPricer {
public:
    ZeroCouponInflationSwapResult price(const ZeroCouponInflationSwapInputs& inputs,
...
#endif // QUANTRA_ZERO_COUPON_INFLATION_SWAP_PRICER_H
