#ifndef QUANTRA_CDS_PRICER_H
#define QUANTRA_CDS_PRICER_H

/**
 * CdsPricer — pure QuantLib pricing core for credit default swaps.
 *
...
/// already converted enums to QL types and parsed the schedule; the pricer
...
class CdsPricer {
public:
    CdsResult price(const CdsInputs& inputs,
