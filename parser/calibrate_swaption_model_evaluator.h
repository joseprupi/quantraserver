#ifndef QUANTRA_CALIBRATE_SWAPTION_MODEL_EVALUATOR_H
#define QUANTRA_CALIBRATE_SWAPTION_MODEL_EVALUATOR_H

/**
 * CalibrateSwaptionModelEvaluator — pure QuantLib core for the Hull-White swaption
 ...
 * this evaluator just hands it the already-resolved plain calibration domain and
 ...
 * calibrate_swaption_model_mapper.{h,cpp}. The evaluator reads market data only
...
#endif // QUANTRA_CALIBRATE_SWAPTION_MODEL_EVALUATOR_H
