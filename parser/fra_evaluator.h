#ifndef QUANTRA_FRA_EVALUATOR_H
#define QUANTRA_FRA_EVALUATOR_H

/**
 * FraEvaluator — pure QuantLib pricing core for Forward Rate Agreements
 ...
 * fra_mapper.{h,cpp}. The evaluator reads market data exclusively from the
