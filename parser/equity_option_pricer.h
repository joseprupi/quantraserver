#ifndef QUANTRA_EQUITY_OPTION_PRICER_H
#define QUANTRA_EQUITY_OPTION_PRICER_H

/**
 * EquityOptionPricer — pure QuantLib pricing core for equity vanilla and
 * barrier options.
 *
...
/// object; the pricer never touches FlatBuffers.
...
class EquityOptionPricer {
public:
    EquityOptionResult price(const EquityOptionInputs& inputs,
...
#endif // QUANTRA_EQUITY_OPTION_PRICER_H
