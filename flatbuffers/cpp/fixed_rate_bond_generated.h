...
struct FixedRateBondT : public ::flatbuffers::NativeTable {
  ...
  FixedRateBondT() = default;
  FixedRateBondT(const FixedRateBondT &o);
  FixedRateBondT(FixedRateBondT&&) FLATBUFFERS_NOEXCEPT = default;
...
inline FixedRateBondT::FixedRateBondT(const FixedRateBondT &o)
...
inline FixedRateBondT &FixedRateBondT::operator=(FixedRateBondT o) FLATBUFFERS_NOEXCEPT {
