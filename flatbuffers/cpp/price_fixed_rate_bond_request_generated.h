...
struct PriceFixedRateBondT : public ::flatbuffers::NativeTable {
  ...
  PriceFixedRateBondT() = default;
  PriceFixedRateBondT(const PriceFixedRateBondT &o);
  PriceFixedRateBondT(PriceFixedRateBondT&&) FLATBUFFERS_NOEXCEPT = default;
  PriceFixedRateBondT &operator=(PriceFixedRateBondT o) FLATBUFFERS_NOEXCEPT;
};
...
struct PriceFixedRateBondRequestT : public ::flatbuffers::NativeTable {
  ...
  PriceFixedRateBondRequestT() = default;
  PriceFixedRateBondRequestT(const PriceFixedRateBondRequestT &o);
  PriceFixedRateBondRequestT(PriceFixedRateBondRequestT&&) FLATBUFFERS_NOEXCEPT = default;
  PriceFixedRateBondRequestT &operator=(PriceFixedRateBondRequestT o) FLATBUFFERS_NOEXCEPT;
};
...
inline PriceFixedRateBondT::PriceFixedRateBondT(const PriceFixedRateBondT &o)
      : fixed_rate_bond((o.fixed_rate_bond) ? new quantra::FixedRateBondT(*o.fixed_rate_bond) : nullptr),
        discounting_curve(o.discounting_curve),
        yield((o.yield) ? new quantra::YieldT(*o.yield) : nullptr) {
}

inline PriceFixedRateBondT &PriceFixedRateBondT::operator=(PriceFixedRateBondT o) FLATBUFFERS_NOEXCEPT {
  std::swap(fixed_rate_bond, o.fixed_rate_bond);
...
inline void PriceFixedRateBond::UnPackTo(PriceFixedRateBondT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = fixed_rate_bond(); if (_e) { if(_o->fixed_rate_bond) { _e->UnPackTo(_o->fixed_rate_bond.get(), _resolver); } else { _o->fixed_rate_bond = std::unique_ptr<quantra::FixedRateBondT>(_e->UnPack(_resolver)); } } else if (_o->fixed_rate_bond) { _o->fixed_rate_bond.reset(); } }
...
inline PriceFixedRateBondRequestT::PriceFixedRateBondRequestT(const PriceFixedRateBondRequestT &o)
      : pricing((o.pricing) ? new quantra::PricingT(*o.pricing) : nullptr) {
  bonds.reserve(o.bonds.size());
  for (const auto &bonds_ : o.bonds) { bonds.emplace_back((bonds_) ? new quantra::PriceFixedRateBondT(*bonds_) : nullptr); }
}

inline PriceFixedRateBondRequestT &PriceFixedRateBondRequestT::operator=(PriceFixedRateBondRequestT o) FLATBUFFERS_NOEXCEPT {
...
inline void PriceFixedRateBondRequest::UnPackTo(PriceFixedRateBondRequestT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = bonds(); if (_e) { _o->bonds.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->bonds[_i]) { _e->Get(_i)->UnPackTo(_o->bonds[_i].get(), _resolver); } else { _o->bonds[_i] = std::unique_ptr<quantra::PriceFixedRateBondT>(_e->Get(_i)->UnPack(_resolver)); }; } } else { _o->bonds.resize(0); } }
}
