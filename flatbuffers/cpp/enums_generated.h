...
enum OvernightIndex : int8_t {
  OvernightIndex_SOFR = 0,
  OvernightIndex_ESTR = 1,
  OvernightIndex_SONIA = 2,
  OvernightIndex_FedFunds = 3,
  OvernightIndex_EONIA = 4,
  OvernightIndex_MIN = OvernightIndex_SOFR,
  OvernightIndex_MAX = OvernightIndex_EONIA
};

inline const OvernightIndex (&EnumValuesOvernightIndex())[5] {
  static const OvernightIndex values[] = {
    OvernightIndex_SOFR,
    OvernightIndex_ESTR,
    OvernightIndex_SONIA,
    OvernightIndex_FedFunds,
    OvernightIndex_EONIA
  };
  return values;
}

inline const char * const *EnumNamesOvernightIndex() {
  static const char * const names[6] = {
    "SOFR",
    "ESTR",
    "SONIA",
...
inline const char *EnumNameOvernightIndex(OvernightIndex e) {
  if (::flatbuffers::IsOutRange(e, OvernightIndex_SOFR, OvernightIndex_EONIA)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOvernightIndex()[index];
}

enum IborFamily : int8_t {
  IborFamily_Euribor = 0,
  IborFamily_USDLibor = 1,
  IborFamily_GBPLibor = 2,
  IborFamily_JPYLibor = 3,
  IborFamily_Tibor = 4,
  IborFamily_MIN = IborFamily_Euribor,
  IborFamily_MAX = IborFamily_Tibor
};

inline const IborFamily (&EnumValuesIborFamily())[5] {
  static const IborFamily values[] = {
    IborFamily_Euribor,
    IborFamily_USDLibor,
    IborFamily_GBPLibor,
    IborFamily_JPYLibor,
...
inline const char * const *EnumNamesIborFamily() {
  static const char * const names[6] = {
    "Euribor",
    "USDLibor",
    "GBPLibor",
...
inline const char *EnumNameIborFamily(IborFamily e) {
  if (::flatbuffers::IsOutRange(e, IborFamily_Euribor, IborFamily_Tibor)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesIborFamily()[index];
}
